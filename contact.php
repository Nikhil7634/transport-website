...
<head>
  ...
  <link rel="alternate" type="application/json" href="https://themexriver.com/fastrans-theme/fastrans/wp-json/wp/v2/pages/1011" />
  ...
  <link rel="canonical" href="https://themexriver.com/fastrans-theme/fastrans/contact/" />
  <link rel="shortlink" href="https://themexriver.com/fastrans-theme/fastrans/?p=1011" />
  <link rel="alternate" type="application/json+oembed" href="https://themexriver.com/fastrans-theme/fastrans/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthemexriver.com%2Ffastrans-theme%2Ffastrans%2Fcontact%2F" />
  <link rel="alternate" type="text/xml+oembed" href="https://themexriver.com/fastrans-theme/fastrans/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthemexriver.com%2Ffastrans-theme%2Ffastrans%2Fcontact%2F&#038;format=xml" />
  <script type="text/javascript">
    var ajaxurl =
...
<body class="page-template page-template-tpl-default-elementor page-template-tpl-default-elementor-php page page-id-1011 wp-custom-logo theme-fastrans woocommerce-no-js ehf-template-fastrans ehf-stylesheet-fastrans menu-layer elementor-default elementor-kit-5 elementor-page elementor-page-1011">
  <div class="boxed_wrapper">
    ...
    <div data-elementor-type="wp-page" data-elementor-id="1011" class="elementor elementor-1011">
      <section class="elementor-section elementor-top-section elementor-element elementor-element-f31af09 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="f31af09" data-element_type="section">
        <div class="elementor-container elementor-column-gap-default">
          <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-61d0157" data-id="61d0157" data-element_type="column">
            <div class="elementor-widget-wrap elementor-element-populated">
              <div class="elementor-element elementor-element-4e7a4bb elementor-widget elementor-widget-fastrans_contact_us" data-id="4e7a4bb" data-element_type="widget" data-widget_type="fastrans_contact_us.default">
                        ...
                        <div class="row">
                              ...
                              <div class="ft-contact-page-contact-info">
                                <div class="ft-contact-cta-items d-flex">
                                  ...
                                  <div class="ft-contact-cta-text headline pera-content">
                                    ...
                                    <p>
                                      Infront of saravali ground,osspada, Saravali, Maharashtra 401501
                                    </p>
                                  </div>
                                </div>
                                <div class="ft-contact-cta-items d-flex">
                          ...
                          <div class="col-lg-6">
                            <div class="ft-contact-page-form-wrapper headline">
                              ...
                              <div class="wpcf7 no-js" id="wpcf7-f1013-p1011-o1" lang="en-US" dir="ltr">
                                <div class="screen-reader-response">
                                  <p role="status" aria-live="polite" aria-atomic="true"></p>
                                  <ul></ul>
                                </div>
                                <form action="/fastrans-theme/fastrans/contact/#wpcf7-f1013-p1011-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                                  <div style="display: none">
                                    <input type="hidden" name="_wpcf7" value="1013" />
                                    <input type="hidden" name="_wpcf7_version" value="5.7.6" />
                                    <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                    <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1013-p1011-o1" />
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="text-475">
                                          <input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Your Name *" value="" type="text" name="text-475" />
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-6">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="email-621">
                                          <input size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email" value="" type="email" name="email-621" />
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-6">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="text-476">
                                          <input size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Affiliation" value="" type="text" name="text-476" />
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-6">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="text-477">
                                          <input size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Number" value="" type="text" name="text-477" />
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-6">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="text-478">
                                          <input size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Inquiry Department" value="" type="text" name="text-478" />
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-6">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="text-479">
                                          <input size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Date" value="" type="text" name="text-479" />
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-12">
                                      <p>
                                        <span class="wpcf7-form-control-wrap" data-name="textarea-527">
                                          <textarea cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Your Message" name="textarea-527"></textarea>
                                        </span>
                                      </p>
                                    </div>
                                    <div class="col-lg-12">
